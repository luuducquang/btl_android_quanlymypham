...
public class LoginDataBaseHandler extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        String createTableQuery = "CREATE TABLE IF NOT EXISTS DangNhap (id INTEGER PRIMARY KEY AUTOINCREMENT, TaiKhoan TEXT, MatKhau TEXT, HoTen TEXT, Email TEXT,AnhDaiDien TEXT,Quyen TEXT);";
    ...
    public void insertData(String TaiKhoan, String MatKhau,String HoTen,String Email,String AnhDaiDien, String Quyen ) {
